...
--- Writes a 32-bit unsigned integer to a file in big-endian byte order
-- @param file An open file handle for writing
-- @param i The integer to write (0 <= i <= 0xFFFFFFFF)
...
--- Writes a 16-bit unsigned integer to a file in big-endian byte order
-- @param file An open file handle for writing
-- @param i The integer to write (0 <= i <= 0xFFFF)
...
--- Writes an 8-bit unsigned integer to a file
-- @param file An open file handle for writing
-- @param i The integer to write (0 <= i <= 0xFF)
...
--- Reads a 32-bit unsigned integer from a file in big-endian byte order
-- @param file An open file handle for reading
...
--- Reads a 16-bit unsigned integer from a file in big-endian byte order
-- @param file An open file handle for reading
